...
export default function KeywordsGenerator() {
  ...
  const keywordsSchema = {
    ...
    '@type': 'WebApplication',
    'name': 'Etsy Product Keywords Generator',
    'url': 'https://etsy-ai-generators.com/keywords',
    'description': 'Boost your Etsy listings with our free AI keywords generator. Enter product details to get search-optimized keywords instantly!',
  ...
  return (
    <>
      <SEO
        title="Etsy Product Keywords Generator - Optimize Your Listings"
        description="Boost your Etsy listings with our free AI keywords generator. Enter product details to get search-optimized keywords instantly!"
        keywords="Etsy keywords generator, AI Etsy keywords, Etsy SEO tool, product tags, search optimization"
            ...
            <div className={`bg-white p-6 rounded-lg shadow-md border border-gray-100 transition-opacity duration-300 ${loading && regenerating ? 'opacity-60' : 'opacity-100'} ${!previousResult && loading ? 'hidden' : ''}`}>
              <div className="flex justify-between items-center mb-4">
                <h2 className="text-xl font-semibold text-[#232347]">
                  {loading && regenerating ? 'Regenerating Keywords...' : 'Generated Keywords:'}
                </h2>
